...
<logic:messagesPresent message="true">
	<%  Exception e = (Exception)request.getSession().getAttribute(org.apache.struts.Globals.EXCEPTION_KEY); 
		...
		if(e != null) {
			...
			request.getSession().getServletContext().getContext("/controleacesso").setAttribute("stackTrace", stackTrace);
	%>

		<script>
			function stackTrace() { 
				window.open('/controleacesso/stackTrace.jsp','StackTrace','width=1024,height=600,scrollbars=yes');
			}	
		</script>
	<%
		}
